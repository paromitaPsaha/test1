package Assignment_1_CucumberBDD.StepDef;
...
import Assignment_1_CucumberBDD.PageObject.CommonPageObject;
import Assignment_1_CucumberBDD.PageObject.FooterObject;
import Assignment_1_CucumberBDD.PageObject.SigninPageObject;
...
public class StepDefFile {
	...
	//-----------------------Creating object of page object------------------------------
	...
	public void setUp(Scenario scn)
	{
		...
		String browserName= WebDriverFactory1.getBrowserName();
		driver=WebDriverFactory1.getDriver(browserName); 
		scn.log("Browser get invoked");

		//Initialize object of page objects classes 
		cmnPageObject= new CommonPageObject(driver, scn);
		footerObject= new FooterObject(driver, scn);
		signInObject= new SigninPageObject(driver, scn);
	}

	//-----After hook : higher order no will execute first------
	...
	public void user_navigate_to_url_and_open_the_landing_page() {
		WebDriverFactory1.navigateToURL(base_url);
	}
